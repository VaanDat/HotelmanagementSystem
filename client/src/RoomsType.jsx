                        ...
                        RoomsTypeData.map((value) => {
                            return(
                                ...
                                <div className="w-[300px] cursor-pointer rounded-2xl flex h-[400px] relative top-[140px] -left-[80px] bg-white text-center">
                                    ...
                                    <div className={`bg-[#60a5fa] py-2 px-8 rounded-tl-xl rounded-br-xl absolute bottom-0 right-0 font-delafield text-white text-4xl ${value.type === "A" && "bg-[#a8a9ac]"} ${value.type === "B" && "bg-slate-600"} ${value.type === "C" && "bg-[#1d3557]"}`}>{value.type}</div>
                                </div>
