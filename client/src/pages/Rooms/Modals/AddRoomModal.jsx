...
export default function AddRoomModal({ close }) {
    ...
    return (
        <div className="">
            ...
            <form className="w-[32rem] grid grid-cols-2 gap-x-2 gap-y-12 items-center ml-4">
                ...
                <div className="relative mt-[-10px]">
                    ...
                    <button className="right-0 bottom-0 absolute translate-y-20 -translate-x-8 bg-[#374151] text-white p-2 rounded-lg" onClick={addRoom}>Save Changes</button>
                </div>
            </form>
        </div>
    )
