...
export default function ActionCustomerModal({
  close,
  ID,
  name,
  room,
  ...
  const UpdateCustomer = (ID) => {
    ...
    axios
      .put("http://localhost:5000/updatecustomers", {
        id: ID,
        name: nFULL_NAME,
        room: nROOM,
        gender: nGENDER,
  ...
  return (
    <div className="pl-24 h-[22rem]">
      ...
      <form
        ...
        className="grid grid-rows-4 grid-flow-col gap-x-2 gap-y-4 -translate-x-16"
      >
        ...
        <div className="relative mt-4 translate-y-[16rem]">
          <button
          ...
          <button
            className="right-0 bottom-0 absolute -translate-x-4 bg-emerald-700 text-white p-2 w-[8rem] rounded-lg cursor-pointer"
            type="submit"
            onClick={() => {
              UpdateCustomer(ID);
            }}
