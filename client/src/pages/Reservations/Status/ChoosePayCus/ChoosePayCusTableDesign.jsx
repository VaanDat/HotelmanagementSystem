...
const ChoosePayCusTableDesign = ({ tableInstance, filter }) => {
           ...
           <tr {...headerGroup.getHeaderGroupProps()}>
             {headerGroup.headers.map(column => (
               ...
               >
                 ...
                 <div className='absolute translate-y-[-4.5rem]' >{column.canFilter ? column.render("Filter") : null}</div>
               </th>
             ))}
           </tr>
         ))}
...
export default ChoosePayCusTableDesign;